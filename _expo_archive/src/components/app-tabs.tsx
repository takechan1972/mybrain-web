  ...
  return (
    <NativeTabs
      ...
      <NativeTabs.Trigger name="memos">
        <NativeTabs.Trigger.Label>メモ</NativeTabs.Trigger.Label>
        <NativeTabs.Trigger.Icon
          src={require('@/assets/images/tabIcons/home.png')}
          renderingMode="template"
        />
      ...
      <NativeTabs.Trigger name="reservations">
        <NativeTabs.Trigger.Label>予定</NativeTabs.Trigger.Label>
        <NativeTabs.Trigger.Icon
      ...
      <NativeTabs.Trigger name="consult">
        <NativeTabs.Trigger.Label>AI相談</NativeTabs.Trigger.Label>
        <NativeTabs.Trigger.Icon
          src={require('@/assets/images/tabIcons/explore.png')}
          renderingMode="template"
        />
