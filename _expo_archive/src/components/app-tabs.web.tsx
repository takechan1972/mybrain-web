    ...
    <Tabs>
      ...
      <TabList asChild>
        <CustomTabList>
          ...
          <TabTrigger name="memos" href="/memos" asChild>
            <TabButton>メモ</TabButton>
          </TabTrigger>
          <TabTrigger name="reservations" href="/reservations" asChild>
            <TabButton>予定</TabButton>
          </TabTrigger>
          <TabTrigger name="consult" href="/consult" asChild>
            <TabButton>AI相談</TabButton>
          </TabTrigger>
          <TabTrigger name="chat" href="/chat" asChild>
            <TabButton>AIチャット</TabButton>
          </TabTrigger>
